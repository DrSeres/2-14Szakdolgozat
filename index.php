  ...
  <header>
    <nav>
      <ul>
        ...
        <li><a href=""> <?= (isset($_SESSION["user_name"]) ? "<span style='color:blue'> Üdvözöllek </span>" . $_SESSION['user_name'] : "<span style='color:red'> Üdvözöllek Admin </span>" . $_SESSION['admin_name']); ?> </a></li>
        <?php

       if (isset($_SESSION['user_name']) || isset($_SESSION['admin_name'])) {
         echo '<li><a href="foBejelentkezes.php">Kijelentkezés</a></li>';
         session_unset();
         session_destroy();
        }
    ...
    <div class="main">
      <div class="flexbox-container">
        <div class="flex-box hover-img">
          ...
          <figcaption>
            <a href="processzor/processzor.php">
              <h3>Processzor</h3>
            </a>
          </figcaption>
        </div>
        <div class="flex-box hover-img">
          ...
          <figcaption>
            <a href="processzorHuto/processzorHuto.php">
      ...
      <div class="flexbox-container">
        <div class="flex-box hover-img">
          ...
          <figcaption>
            ...
            <a href="videokartya/videokartya.php">
              <h3>Videókártya</h3>
            </a>
          </figcaption>
        </div>
        ...
        <div class="flex-box hover-img">
          ...
          <figcaption>
            <a href="rendszerHuto/rendszerHuto.php">
              <h3>Rendszerhűtő</h3>
            </a>
          </figcaption>
        </div>
      ...
      <div class="flexbox-container">
        ...
        <div class="flex-box hover-img">
          ...
          <figcaption>
            <a href="tapegyseg/tapegyseg.php">
              <h3>Tápegység</h3>
            </a>
