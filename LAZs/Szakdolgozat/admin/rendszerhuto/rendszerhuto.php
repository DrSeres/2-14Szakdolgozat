...
<body>
    ...
    <main id="main">
        <h2 id="kategoria">Rendszerhűtők széles választékban</h2>
        <p><a href="felvetel.php">Új rendszerhűtő hozzáadása</a> | <a href="../kategoria.html">Vissza a főoldalra</a></p>
        <div class="main">
