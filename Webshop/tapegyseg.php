...
session_start();
$sql = "SELECT * FROM termek INNER JOIN gyartokategoria ON termek.gyartoKategoriaId=gyartokategoria.gyartoKategoriaId INNER JOIN gyarto ON gyartokategoria.gyartoId=gyarto.gyartoId WHERE gyartokategoria.kategoriaID = 8";
...
$sql = "SELECT * FROM termek INNER JOIN gyartokategoria ON termek.gyartoKategoriaId=gyartokategoria.gyartoKategoriaId INNER JOIN gyarto ON gyartokategoria.gyartoId=gyarto.gyartoId WHERE gyartokategoria.kategoriaID = 8 ORDER BY 1 ASC 
...
<<<URLAP
    <article>
    <div class="border">
    <a href=tapegyseg_adat.php?id={$sor['id']}">
    <img src="../img/tapegyseg/{$sor['foto']}" alt="{$sor['foto']} "></a>
