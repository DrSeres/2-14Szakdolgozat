...
while($sor = mysqli_fetch_assoc($eredmeny)) {
    ...
    <div class=\"main\">
        <div class=\"grid-container\">
            <div class=\"adat\">
            <img src='../img/memoria/{$sor['foto']}' class='kep'>
            </div>
            <div class=\"adat\">
...
<body>
    ...
    <nav>
            <ul>
              ...
              <li><a href="ram.php" class='Vissza'>Vissza a termékekhez</a></li>
...
<!-- 
        <p>Magok száma: {$sor['kapacitas']}</p>
                <p>Szálak száma: {$sor['kiszereles']}</p>
                <p>Processzor foglalat: {$sor['memoria_tipus']}</p>
                <p>Processzor foglalat: {$sor['memoria_tipus']}</p>
                <p>Processzor foglalat: {$sor['memoria_tipus']}</p> -->
