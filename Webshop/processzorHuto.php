...
$sql = "SELECT * FROM kategoria INNER JOIN gyarto ON kategoria.kategoriaID=gyarto.kategoriaID INNER JOIN termek ON gyarto.gyartoId=termek.markaId WHERE kategoria.kategoriaID = 5 ORDER BY gyarto.gyartoId ASC 
...
<<<URLAP
    <article>
    <div class="border">
    <a href=processzorHuto_adat.php?id={$sor['id']}">
