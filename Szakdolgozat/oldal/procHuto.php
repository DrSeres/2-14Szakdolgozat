...
$sql = "SELECT * FROM proba2 ORDER BY id ASC";
...
<head>
    ...
    <link rel="stylesheet" href="../css/sablon.css"><link href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.2.1/css/all.min.css" rel="stylesheet">
</head>
<body>
    <h1>asd</h1>
<header class="header">
